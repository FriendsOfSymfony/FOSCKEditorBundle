...
class CKEditorInstallerTest extends TestCase
{
    ...
    {
        $this->installer->install($options = ['release' => CKEditorPredefinedBuild::RELEASE_CUSTOM, 'custom_build_id' => '1f3be008844363d511af408ce2cb1396']);
    ...
    public function testInstallWithCustomBuildWithInvalidVersion(): void
    {
        ...
        $this->installer->install(['release' => CKEditorPredefinedBuild::RELEASE_CUSTOM, 'custom_build_id' => '1f3be008844363d511af408ce2cb1396', 'version' => '4.11.4']);
    }
